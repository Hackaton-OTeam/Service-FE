...
import MoneyContent from "@/assets/commonknowledge/MoneyContent.png";
import ForeignContent from "@/assets/commonknowledge/ForeignContent.png";
...
import BusinessContent from "@/assets/commonknowledge/BusinessContent.png";
...
import AppleContent from "@/assets/commonknowledge/AppleContent.png";
...
export const useManageCommonSense = (id: number, keyword: string) => {
  ...
  return {
    ...
    content: knowledge.contentImage,
  };
};
